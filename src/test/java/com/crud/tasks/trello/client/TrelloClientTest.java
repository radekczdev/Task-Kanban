...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        when(trelloConfig.getUsername()).thenReturn("user");
    }
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        trelloBoards[0] = new TrelloBoardDto("test_id", "test_board", Collections.emptyList());

        URI url = new URI("http://test.com/members/user/boards?key=test&token=test&fields=name,id&lists=all");
        ...
        assertEquals(Collections.emptyList(), fetchedTrelloBoards.get(0).getLists());
    }
